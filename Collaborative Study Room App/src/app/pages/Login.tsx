        ...
        <div className="bg-card border border-border rounded-2xl p-8 shadow-lg">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <a
                href="#"
                className="text-primary hover:text-primary/80 transition-colors focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-card rounded"
              >
                Forgot password?
              </a>
            </div>
          ...
          <p className="mt-6 text-center text-sm text-muted-foreground">
            ...
            <Link to="/register" className="text-primary hover:text-primary/80 transition-colors font-medium focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 focus:ring-offset-card rounded">
              Sign up
            </Link>
          </p>
        </div>
